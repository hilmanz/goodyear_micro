...
$username="sample"; // Mysql username 
$password="sample"; // Mysql password 
$db_name="chating"; // Database name 
$tbl_name="tableexam"; // Table name 
...
$sql="SELECT * FROM $tbl_name WHERE no='$no'";
...
?>
	...
	<form method="post" action="edit-data.php">
        ...
        <tr>
          <td>Address</td>
          <td><input type="text" name="alamat" size="40" value="<? echo $rows['alamat']; ?>">
          </td>
        </tr>
        <tr>
          <td>Email</td>
